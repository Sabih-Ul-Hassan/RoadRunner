                    ...
                    <div class="container users-data">
                        <div class="row">
                            <div class="col-10 col-md-5 offset-1">
                                <h4>First Name</h4>
                                <p id="user-firstName">some first Name</p>
                            </div>
                            <div class="col-10 col-md-5 offset-1">
                                <h4>Last Name</h4>
                                <p id="user-lastName">some last Name</p>
                            </div>

                            <div class="col-10 col-md-5 offset-1">
                                <h4>User Name</h4>
                                <p id="user-username">SomeUserName</p>
                            </div>
                            <div class="col-10 col-md-5 offset-1">
                                <h4>Date Of Birth</h4>
                                <p id="user-dob">22-12-2002</p>
                            </div>
                            <div class="col-10 offset-1">
                                <h4>Email</h4>
                                <p id="user-email">sth.sth.123@idkSth.co.pk</p>
                            </div>
                            <div class="col-12">
                                <div class='row'>
                                    <button class='col-md-3 offset-md-4 offset-1 col-4  btn btn-outline-success  '>
                                            Edit Profile
                                    </button>
                                    <button class='col-md-3 offset-md-1 offset-1 col-4 btn btn-outline-danger  '>
                                            Delete Profile
                                    </button>
                                </div>
                            </div>
