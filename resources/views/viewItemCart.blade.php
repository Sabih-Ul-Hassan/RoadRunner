...
<body>
    <div class="fluid-container">
        ...
        <div class="container cart-container">
            ...
            <div class="row d-flex cart-items-container">
                <div class="col-lg-9 col-md-7 col-sm-12 col-12">
                    <div class="row cart-item-summary-background mb-3">
                        <div class="col-lg-3 col-md-5 col-sm-6 col-6">
                            <img src="images/productImages/Buoyant_Blue_Blizzard.png" width="175" height="175" alt="">
                        </div>
                        <div class="col-lg-3 col-md-7 col-sm-6 col-6 item-details-custom">
                            <div class="item-details">
                                <span class="item-name">Electric Leggings</span>
                                <span class="size">Size: <span>Medium</span></span>
                                <span class="color">Color: <span>Storm</span></span>
                                <span class="price">Price: <span>$145.99</span></span>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-5 col-sm-6 col-6 item-numbers-custom p-0">
                            <div class="items p-lg-2 pl-md-4 pl-sm-5 pl-5">
                                <button type="button" class="item-cart-add-remove-btn-custom">-</button>
                                <input type="text" class="item-cart-number">
                                <button type="button" class="item-cart-add-remove-btn-custom">+</button>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-7 col-sm-6 col-6 p-0 cartItem-actions">
                            <div class="items">
                                <ul class="cartItem-elements-actions-custom p-0">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="icons/heart-solid.svg" alt="Favorite" width="21" height="21" class="d-inline-block align-top">
                    ...
                    <div class="row cart-item-summary-background mb-3">
                        <div class="col-lg-3 col-md-5 col-sm-6 col-6">
                            <img src="images/productImages/Forager_White_Humid_Rust.png" width="175" height="175" alt="">
                        </div>
                        <div class="col-lg-3 col-md-7 col-sm-6 col-6 item-details-custom">
                            <div class="item-details">
                                <span class="item-name">Electric Leggings</span>
                    ...
                    <div class="row cart-item-summary-background mb-3">
                        <div class="col-lg-3 col-md-5 col-sm-6 col-6">
                            <img src="images/productImages/HAZY_COBALT_ULTRAMARINE.png" width="175" height="175" alt="">
                        </div>
                        <div class="col-lg-3 col-md-7 col-sm-6 col-6 item-details-custom">
                            <div class="item-details">
                                <span class="item-name">Electric Leggings</span>
                ...
                <div class="col-lg-3 col-md-5 col-sm-12  col-12">
                    <div class="summary-details cart-item-summary">
                        ...
                        <div class="subtotal summary-item">
                            <span>Subtotal</span><span>$388.00</span>
                        </div>
                        <div class="coupon summary-item">
                            <span>Coupon</span><span>- $78.00</span>
                        </div>
                        <div class="giftcard summary-item">
                            <span>Gift Card</span><span>- $100.00</span>
                        </div>
                        <div class="tax summary-item">
                            <span>Estimated Tax</span><span>$23.00</span>
                        </div>
                        ...
                        <div class="total summary-item summary-item-total">
                            <span>Estimated Total</span><span>$233.68</span>
                        </div>
                        <div class="order-button">
                            <button type="button" id="order-button-custom" class="order-button-custom">Order</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        var order = document.getElementById('order-button-custom');
